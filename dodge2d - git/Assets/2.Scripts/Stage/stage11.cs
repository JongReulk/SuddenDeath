...
public class stage11 : MonoBehaviour
{
    ...
    private int bestScore_11_easy;
    private int bestScore_11_hard;
    private int bestScore_11_ultra;
    ...
    void Start()
    {
        ...
        bestScore_11_easy = PlayerPrefs.GetInt("bestScore_11_easy", 1);
        bestScore_11_hard = PlayerPrefs.GetInt("bestScore_11_hard", 1);
        bestScore_11_ultra = PlayerPrefs.GetInt("bestScore_11_ultra", 1);
        ...
        if (gameModenum == 0)
        {
            if (surviveTime >= easyTime)
            {
                ...
                if (easyLevelat <= 11)
                {
                    ...
                    PlayerPrefs.SetInt("easyLevelat", 12);
        ...
        if (gameModenum == 1)
        {
...

            {
                ...
                if (hardLevelat <= 11)
                {
                    ...
                    PlayerPrefs.SetInt("hardLevelat", 12);
        ...
        if (gameModenum == 2)
        {
            if (surviveTime >= ultraTime)
            {
                ...
                if (ultraLevelat <= 11)
                {
                    ...
                    UIManager.instance.SetActivePassTextUI(true);
                    PlayerPrefs.SetInt("ultraLevelat", 12);
    ...
    void ShowBestScore()
    {
        if (gameModenum == 0)
        {
            if (surviveTime > bestScore_11_easy)
            {

                bestScore_11_easy = (int)surviveTime;
                PlayerPrefs.SetInt("bestScore_11_easy", (int)surviveTime); // 나중에 스테이지별 스크립트에서 가져오기
                UIManager.instance.SetActiveReachedBestUI(true);
            }
            bestScore_11_easy = PlayerPrefs.GetInt("bestScore_11_easy");

            int easy_minutes = (int)(bestScore_11_easy / 60) % 60;
            int easy_seconds = (int)(bestScore_11_easy % 60);
        ...
        if (gameModenum == 1)
        {
            if (surviveTime > bestScore_11_hard)
            {

                bestScore_11_hard = (int)surviveTime;
                PlayerPrefs.SetInt("bestScore_11_hard", (int)surviveTime); // 나중에 스테이지별 스크립트에서 가져오기
                UIManager.instance.SetActiveReachedBestUI(true);
            }
            bestScore_11_hard = PlayerPrefs.GetInt("bestScore_11_hard");

            int hard_minutes = (int)(bestScore_11_hard / 60) % 60;
            int hard_seconds = (int)(bestScore_11_hard % 60);
        ...
        if (gameModenum == 2)
        {
            if (surviveTime > bestScore_11_ultra)
            {

                bestScore_11_ultra = (int)surviveTime;
                PlayerPrefs.SetInt("bestScore_11_ultra", (int)surviveTime); // 나중에 스테이지별 스크립트에서 가져오기
                UIManager.instance.SetActiveReachedBestUI(true);
            }
            bestScore_11_ultra = PlayerPrefs.GetInt("bestScore_11_ultra");

            int ultra_minutes = (int)(bestScore_11_ultra / 60) % 60;
            int ultra_seconds = (int)(bestScore_11_ultra % 60);
