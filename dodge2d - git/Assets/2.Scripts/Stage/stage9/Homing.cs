...
public class Homing : MonoBehaviour
{
    ...
    public GameObject player1_ho;
    public GameObject player2_ho;
    ...
    void FixedUpdate()
    {
        ...
        if (!player1_ho.activeInHierarchy)
        {
            Target1 = Target2;
        }

        if (!player2_ho.activeInHierarchy)
        {
            Target2 = Target1;
        }
        if (!player2_ho.activeInHierarchy && !player1_ho.activeInHierarchy)
        {
