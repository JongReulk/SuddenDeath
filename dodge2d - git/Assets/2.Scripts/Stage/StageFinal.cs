...
public class StageFinal : MonoBehaviour
{
    ...
    private int bestScore_12_easy;
    private int bestScore_12_hard;
    private int bestScore_12_ultra;
    ...
    void Start()
    {
        ...
        bestScore_12_easy = PlayerPrefs.GetInt("bestScore_12_easy", 1);
        bestScore_12_hard = PlayerPrefs.GetInt("bestScore_12_hard", 1);
        bestScore_12_ultra = PlayerPrefs.GetInt("bestScore_12_ultra", 1);
        ...
        if (gameModenum == 0)
        {
            if (surviveTime >= easyTime)
            {
                ...
                if (easyLevelat <= 12)
                {
                    ...
                    PlayerPrefs.SetInt("easyLevelat", 13);
        ...
        if (gameModenum == 1)
        {
...

            {
                ...
                if (hardLevelat <= 12)
                {
                    ...
                    PlayerPrefs.SetInt("hardLevelat", 13);
        ...
        if (gameModenum == 2)
        {
            if (surviveTime >= ultraTime)
            {
                ...
                if (ultraLevelat <= 12)
                {
                    ...
                    UIManager.instance.SetActivePassTextUI(true);
                    PlayerPrefs.SetInt("ultraLevelat", 13);
    ...
    void ShowBestScore()
    {
        if (gameModenum == 0)
        {
            if (surviveTime > bestScore_12_easy)
            {

                bestScore_12_easy = (int)surviveTime;
                PlayerPrefs.SetInt("bestScore_12_easy", (int)surviveTime); // 나중에 스테이지별 스크립트에서 가져오기
                UIManager.instance.SetActiveReachedBestUI(true);
            }
            bestScore_12_easy = PlayerPrefs.GetInt("bestScore_12_easy");

            int easy_minutes = (int)(bestScore_12_easy / 60) % 60;
            int easy_seconds = (int)(bestScore_12_easy % 60);
        ...
        if (gameModenum == 1)
        {
            if (surviveTime > bestScore_12_hard)
            {

                bestScore_12_hard = (int)surviveTime;
                PlayerPrefs.SetInt("bestScore_12_hard", (int)surviveTime); // 나중에 스테이지별 스크립트에서 가져오기
                UIManager.instance.SetActiveReachedBestUI(true);
            }
            bestScore_12_hard = PlayerPrefs.GetInt("bestScore_12_hard");

            int hard_minutes = (int)(bestScore_12_hard / 60) % 60;
            int hard_seconds = (int)(bestScore_12_hard % 60);
        ...
        if (gameModenum == 2)
        {
            if (surviveTime > bestScore_12_ultra)
            {

                bestScore_12_ultra = (int)surviveTime;
                PlayerPrefs.SetInt("bestScore_12_ultra", (int)surviveTime); // 나중에 스테이지별 스크립트에서 가져오기
                UIManager.instance.SetActiveReachedBestUI(true);
            }
            bestScore_12_ultra = PlayerPrefs.GetInt("bestScore_12_ultra");

            int ultra_minutes = (int)(bestScore_12_ultra / 60) % 60;
            int ultra_seconds = (int)(bestScore_12_ultra % 60);
