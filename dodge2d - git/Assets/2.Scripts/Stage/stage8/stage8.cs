...
public class stage8 : MonoBehaviour
{
    ...
    private int bestScore_8_easy;
    private int bestScore_8_hard;
    private int bestScore_8_ultra;
    ...
    void Start()
    {
        ...
        bestScore_8_easy = PlayerPrefs.GetInt("bestScore_8_easy", 1);
        bestScore_8_hard = PlayerPrefs.GetInt("bestScore_8_hard", 1);
        bestScore_8_ultra = PlayerPrefs.GetInt("bestScore_8_ultra", 1);
        ...
        if (gameModenum == 0)
        {
            if (surviveTime >= easyTime)
            {
                ...
                if (easyLevelat <= 8)
                {
                    ...
                    PlayerPrefs.SetInt("easyLevelat", 9);
        ...
        if (gameModenum == 1)
        {
...

            {
                ...
                if (hardLevelat <= 8)
                {
                    ...
                    PlayerPrefs.SetInt("hardLevelat", 9);
        ...
        if (gameModenum == 2)
        {
            if (surviveTime >= ultraTime)
            {
                ...
                if (ultraLevelat <= 8)
                {
                    ...
                    UIManager.instance.SetActivePassTextUI(true);
                    PlayerPrefs.SetInt("ultraLevelat", 9);
    ...
    void ShowBestScore()
    {
        if (gameModenum == 0)
        {
            if (surviveTime > bestScore_8_easy)
            {

                bestScore_8_easy = (int)surviveTime;
                PlayerPrefs.SetInt("bestScore_8_easy", (int)surviveTime); // 나중에 스테이지별 스크립트에서 가져오기
                UIManager.instance.SetActiveReachedBestUI(true);
            }
            bestScore_8_easy = PlayerPrefs.GetInt("bestScore_8_easy");

            int easy_minutes = (int)(bestScore_8_easy / 60) % 60;
            int easy_seconds = (int)(bestScore_8_easy % 60);
        ...
        if (gameModenum == 1)
        {
            if (surviveTime > bestScore_8_hard)
            {

                bestScore_8_hard = (int)surviveTime;
                PlayerPrefs.SetInt("bestScore_8_hard", (int)surviveTime); // 나중에 스테이지별 스크립트에서 가져오기
                UIManager.instance.SetActiveReachedBestUI(true);
            }
            bestScore_8_hard = PlayerPrefs.GetInt("bestScore_8_hard");

            int hard_minutes = (int)(bestScore_8_hard / 60) % 60;
            int hard_seconds = (int)(bestScore_8_hard % 60);
        ...
        if (gameModenum == 2)
        {
            if (surviveTime > bestScore_8_ultra)
            {

                bestScore_8_ultra = (int)surviveTime;
                PlayerPrefs.SetInt("bestScore_8_ultra", (int)surviveTime); // 나중에 스테이지별 스크립트에서 가져오기
                UIManager.instance.SetActiveReachedBestUI(true);
            }
            bestScore_8_ultra = PlayerPrefs.GetInt("bestScore_8_ultra");

            int ultra_minutes = (int)(bestScore_8_ultra / 60) % 60;
            int ultra_seconds = (int)(bestScore_8_ultra % 60);
